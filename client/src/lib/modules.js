...
export const MODULES = [
  {
    ...
    columns: [
      ...
      { key: 'Entity Role', label: 'Role', type: 'pill', width: 110, filterable: true },
      ...
      { key: 'KYC Status', label: 'KYC', type: 'pill', width: 110, filterable: true },
    ],
  },
  {
    api: 'facility',
    ...
    columns: [
      ...
      { key: 'Facility Type', label: 'Type', width: 130, filterable: true },
      ...
      { key: 'Facility Status', label: 'Status', type: 'pill', width: 120, filterable: true },
    ],
  },
  {
    api: 'collateral',
    ...
    columns: [
      { key: 'Loan Reference', label: 'Loan', type: 'ref', width: 120 },
      { key: 'Collateral Type', label: 'Type', width: 160, filterable: true },
      ...
      { key: 'Legal Opinion', label: 'Legal opinion', type: 'pill', width: 150, filterable: true },
      { key: 'Charge Type', label: 'Charge', width: 120, filterable: true },
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'Internal Rating Grade', label: 'Grade', type: 'num', width: 70, filterable: true },
      ...
      { key: 'Recommendation', label: 'Recommendation', type: 'pill', width: 170, filterable: true },
    ],
  },
  {
    ...
    columns: [
      ...
      { key: 'Category', label: 'Category', width: 150, filterable: true },
      { key: 'Condition Type', label: 'Type', width: 150, filterable: true },
      { key: 'Due Date', label: 'Due', type: 'date', width: 110 },
      { key: 'Compliance Status', label: 'Status', type: 'pill', width: 110, filterable: true },
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'Payment Mode', label: 'Mode', width: 90, filterable: true },
      { key: 'Tranche Status', label: 'Status', type: 'pill', width: 110, filterable: true },
